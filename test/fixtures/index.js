...
module.exports = {
  "session": {
    "request": {
      url: 'https://auth.paycasso.com/api/v1/session',
      method: 'POST',
      headers: {
  ...
  "authorisedlogin": {
    request: {
      url: `https://${serverName}.paycasso.com/api/authorisedlogin`,
      method: 'POST',
      headers: {},
      body: {
        details: {
  ...
  "transactions": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/transactions`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
      body: {
  ...
  "document/data/usdl": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/transactions/f81d4fae-7dec-11d0-a765-00a0c91e6bf6/document/data/usdl`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "document/data/epassport": {
    request: {
      url: `https://${serverName}.paycasso.com/api/transactions/f81d4fae-7dec-11d0-a765-00a0c91e6bf6/document/data/epassport`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "document/data/epassport/face": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/transactions/f81d4fae-7dec-11d0-a765-00a0c91e6bf6/document/data/epassport/face`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "tx-summary": {
    request: {
      url: `https://${serverName}.paycasso.com/api/transactions/f81d4fae-7dec-11d0-a765-00a0c91e6bf6/summary`,
      method: 'GET',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      }
  ...
  "document": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/document`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "face": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/face`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "face/end": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/face/end`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
  ...
  "enroll": {
    "request": {
      url: `https://${serverName}.paycasso.com/api/enrolment/enrol`,
      method: 'POST',
      headers: {
        token: "768b40a8-6c8f-4d93-9d2f-d77d06037b5d"
      },
